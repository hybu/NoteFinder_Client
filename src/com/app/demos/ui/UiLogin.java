...
public class UiLogin extends BaseUi {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		OnClickListener mOnClickRegisterListener = new OnClickListener() {
			@Override
			public void onClick(View v) {
				switch (v.getId()) {
					case R.id.app_login_btn_register : 
						forward(UiRegister.class);
						break;
				}
			}
		};
		findViewById(R.id.app_login_btn_register).setOnClickListener(mOnClickRegisterListener);
	}
